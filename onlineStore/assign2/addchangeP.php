<?php
  ...
  //  echo "3. ".$_POST['product'];
    if(strlen(inp($_POST['productname']))!=0 && $_POST['operation']=="add"){
        $sql1="insert into product (productcategoryid,productname,productdesc,productprice) VALUES ('".inp($_POST['productcategoryid'])."','".inp($_POST['productname'])."','".inp($_POST['productdesc'])."','".inp($_POST['productprice'])."')";
        ...
        //change php
    //    if(){
            $sql2="update product set productcategoryid='".inp($_POST['productcategoryid'])."',productname='".inp($_POST['productname'])."',productdesc='".inp($_POST['productdesc'])."',productprice='".inp($_POST['productprice'])."' where productid='".inp($_POST['product'])."'";
