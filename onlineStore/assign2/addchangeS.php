  ...
  //  echo " 1: ".$_POST['productname'];
   ...
   // echo " 5: ".$_POST['end'];
    ...
    if(strlen(inp($_POST['productname']))!=0 && $_POST['operation']=="add"){
        ...
        $sql1="insert into specialsales (productid,startdate,enddate) VALUES ('".inp($_POST['productname'])."',unix_timestamp('".inp($_POST['start'])."'),unix_timestamp('".inp($_POST['end'])."'))";
        ...
        //change php
    //    if(){
            $sql2="update specialsales set productid='".inp($_POST['productname'])."', startdate=unix_timestamp('".inp($_POST['start'])."'),enddate=unix_timestamp('".inp($_POST['end'])."') where specialsalesid='".inp($_POST['product'])."'";
