<?php
    ...
    if($_POST['succeed']=='succeed'){
        $sql4="update customer set username='".inp($_POST['username'])."',password=password('".inp($_POST['password0'])."'),customername='".inp($_POST['customername'])."',customeraddress='".inp($_POST['customeraddress'])."',creditcard='".inp($_POST['creditcard'])."',securitycode='".inp($_POST['securitycode'])."',expirationdate='".inp($_POST['expirationdate'])."' where customerid='".$id."'";
...
<button class="rightbutton">Order History</button>
        ...
        <div class="box2" style="height:450px;margin:0 auto 0 auto;border:1px solid #edeff4;font-size:20px;color:#999999">
            <p style="font-size:30px;margin:0 auto auto 30px;font-weight:bold">Change Your Information<span style="margin:0 auto auto 40px;font-size:18px;color:#e47911">
            To watch Awesome Videos Online!</span></p>
            <FORM METHOD=POST ACTION="accountinfo.php" onsubmit="return validate_form1(this)">
            ...
            <div style="display:block;float:right;width:500px;height:350px;margin:30px;border:1px solid #bdc7d7;border-radius:6px;">
                    ...
                    <div class="textbox" style="margin:40px 45px auto 30px;float:right;">
                        ...
                        <BUTTON class="submitbutton" TYPE="submit" name="submit" style="color:#fff;">Save</button>
