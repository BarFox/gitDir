...
<strong>Your Account</strong></button>
        ...
        <div class="box2" style="background-color:#2f2f2f;height:370px;">
            <div style="display:block;height:auto;float:left" id="phonebox5">
                ...
                <div style="float:right;height:300px;margin:10px 20px 30px 30px;color:#fff" id="phonebox4">
            ...
            <div style="display:block;height:auto;color:#fff;float:right" id="phonebox6">
