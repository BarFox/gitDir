...
<meta name="viewport" content="width=device-width" />        <title>CS571 Assignment 3</title>
                  ...
                  //  echo $res3;
                    ...
                    //    $row4 = mysql_fetch_assoc($res4);
                     ...
                     //   echo $row4['productname'];
                        ...
                        echo '<a href="'.site_url('ShowP')."/index/".$row3['pid'].'">';
                        ...
                        echo "'".$row3['pid']."'>";
                        echo '<BUTTON  TYPE="submit" name="submit" style="color:#000000;border:1px solid black"> Delete</button>';
                        echo '</div>';
                        echo '</form>';
                        echo '</div>';
                        echo ' </div>';
